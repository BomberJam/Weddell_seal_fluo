...
cropped_SIC_mean <- list_SIC[[idMap]]$mean %>%
  dplyr::filter(x >= crop[1], x <= crop[2],
                y >= crop[3], y <= crop[4])

cropped_SIC_median <- list_SIC[[idMap]]$median %>%
  dplyr::filter(x >= crop[1], x <= crop[2],
                y >= crop[3], y <= crop[4])

cropped_SIC_sd <- list_SIC[[idMap]]$sd %>%
  dplyr::filter(x >= crop[1], x <= crop[2],
                y >= crop[3], y <= crop[4])


plot(cropped_SIC_mean, main = paste0("SIC Mean (", list_SIC[[idMap]]$month_label,")"))
plot(cropped_SIC[[idMap]]$median, main = paste0("SIC Median (", list_SIC[[idMap]]$month_label,")"))
plot(cropped_SIC[[idMap]]$sd, main = paste0("SIC SD (", list_SIC[[idMap]]$month_label,")"))
