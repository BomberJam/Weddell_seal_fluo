...
idprofile <- 6 # Indice du profil affiché sur les plots individuels.
...
# Dossiers de sortie
dir_plot = file.path("oceanographic_data_corrected", DEPLOY_FOLDER, SEAL_NAME)
...
for (i in 1:nlight) {
  ...
  plot(light_non_log[1:MAX_CHLA_DEPTH, i],
       ...
       type = "l",
       col = "blue",
       ylim = rev(range(pres_vec[1:MAX_CHLA_DEPTH])),
       xlim = c(0, 3e-4),
