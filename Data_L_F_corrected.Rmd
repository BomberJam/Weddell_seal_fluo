...
rm(list = ls())  # Supprimer les objets en mémoire
...
DEPLOY_FOLDER <- "wd20" # Lignes à modifier pour changer de deployment SealOfApproval
SEAL_NAME <- paste0(DEPLOY_FOLDER,"-546-19") # ...ou d'individu SealOfApproval
SEAL_FILE <- paste0(SEAL_NAME, "_hr1_prof.nc") # wd20 en hr1, le reste en hr2
...
FAST_ICE_FILE <- "mertz_sara_akiko_23.nc" # SealOfApproval
FAST_ICE_PATH <- file.path(ROOT_PROJ, FAST_ICE_FOLDER, FAST_ICE_FILE)

AMSR_FOLDER <- "amsr2"
AMSR_FOLDER_YEAR <- "2023" # SealOfApproval
...
df_SIC <- list()  # contiendra les data.frames de chaque mois
...
for (m in target_year_months) {
  ...
  # Tout combiner en un seul stack
