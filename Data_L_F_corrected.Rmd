...
fig <- fig %>% layout(
  title = "",
  xaxis = list(title = "Chlorophylle", titlefont = list(color = "green"), tickfont = list(color = "green")),
  xaxis2 = x2,
  yaxis = list(title = "Profondeur (m)", autorange = "reversed"),  # profondeur vers le bas
