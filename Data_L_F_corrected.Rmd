...
ggplot(df_mld, aes(x = profile, y = value)) +
  ...
  scale_y_reverse() +
  labs(x = "Profile", y = "Depth (m)", title = "Mixed Layer Depth (MLD)") +
  theme_minimal()
...
# Exporter en .rds (Difference avec le RData = RData plusieurs objets, rds 1 seul objet (c'est notre cas))
saveRDS(df_final, file = paste0(SEAL_NAME, "_data.rds"))
