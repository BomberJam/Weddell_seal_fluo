...
ggplot(df_quench, aes(x = profile, y = value)) +
  ...
  geom_smooth(aes(y = value), method = "loess", formula = "y ~ x", color = "black", linewidth = 0.25, se = FALSE) +
  scale_y_reverse() +
...
# Dossiers de sortie
dir_plot = file.path("oceanographic_data_corrected", DEPLOY_FOLDER, SEAL_NAME,"chla")
dir.create(dir_plot, showWarnings = FALSE, recursive = TRUE)
...
# Initialisation de la matrice corrigée
CHLA_nadRegDkNpq <- chla_corrected_dk
