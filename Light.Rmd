...
ggplot() +
  ...
  labs(
    title = paste0(
      n_profiles_surf, " profils lumière (", 
      SURFACE_NOT_NAN[1], " à ", SURFACE_NOT_NAN[length(SURFACE_NOT_NAN)], 
      " m de profondeur) + positions interpolées"
    ),
    x = "Longitude",
    y = "Latitude"
  ) +
...
ggplot(df_solar, aes(x = date_subset, y = solar_angle, color = period)) +
  ...
  scale_color_manual(values = c("Day" = "gold", "Twilight" = "green", "Night" = "navy")) +
  theme_minimal()
