...
plot(light_subset_exp_round[1:MAX_CHLA_DEPTH, id_profile], pres[1:MAX_CHLA_DEPTH, id_profile], type = "l", col = "blue",
     ylim = rev(range(pres[1:MAX_CHLA_DEPTH, id_profile])), xlim = c(0,0.005),
...
plot(sal[,n], pres_vec,
     type = "l",
     xlab = "Salinity",
     xlim = range(sal[,n], na.rm = TRUE),
     ylim = rev(c(0, max_depth_dataset)),
     ylab = "")
grid()

# Plot 4: Chla
plot(chla[,n], pres_vec,
     type = "l",
     xlab = "CHLA (fluo)",
     xlim = c(-10, 10),
     ylim = rev(c(0, max_depth_dataset)),
...
pres_vec <- pres[, 1]  # si pres est une matrice
...
plot(chla[1:MAX_CHLA_DEPTH, nprofile], pres_vec[1:MAX_CHLA_DEPTH], type = "l", col = "blue",
     ...
     xlab = "Chl-a (mg/m³)", ylab = "Depth (m)", main = paste("Chl-a profile", nprofile, "-", SEAL_NAME))
